...
console.log(new (Function.prototype.bind.apply(Date, [null].concat(dateField)))()); // 1971-12-31T18:30:00.000Z

// a very useful case of spread
var b = [2, 3, 4];
var a = [1].concat(b, [5, 6, 7]);
console.log(a); // [ 1, 2, 3, 4, 5, 6, 7 ]


var arr = [1, 2, 3];
var arr2 = [].concat(arr); // like arr.slice()
arr2.push(4);
